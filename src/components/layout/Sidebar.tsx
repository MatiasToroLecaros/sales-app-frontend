...
export const Sidebar: React.FC = () => {
  ...
  return (
    <div className="flex h-full w-64 flex-col bg-secondary-950 text-white shadow-lg">
      {/* Logo y título */}
      ...
      {/* Menú de navegación */}
      <nav className="flex-1 pt-6 pb-4 px-3 space-y-1">
      ...
      <div className="mt-auto p-4 border-t border-secondary-800">
        <Link
          to="/profile"
          className="flex items-center rounded-lg p-2 hover:bg-secondary-800 transition-colors"
        >
          <div className="mr-3 h-10 w-10 rounded-full bg-primary-500 flex items-center justify-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
