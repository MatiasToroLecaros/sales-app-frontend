    ...
    <div className="fixed inset-0 z-50 overflow-y-auto" onClick={onClose}>
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        ...
        <div
          ...
          className={clsx(
            "w-full transform overflow-hidden rounded-lg border border-secondary-700 shadow-xl transition-all bg-[#0f172a]", 
        ...
        >
          ...
          <div className="p-5 bg-secondary-950">{children}</div>
        </div>
      </div>
    </div>
  );
